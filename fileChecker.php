<?php
	...
	function CreateFolder($folderName)
	{
		...
		{
			mkdir($folderName);
			return print('<span style ="color:#660000">Der Ordner "'.$folderName.'" wurde erstellt!</span><br>');
    	}
    	else
    		return print('<span style ="color:#007236">Der Ordner "'.$folderName.'" existiert!</span><br>');
	}

	function CreateFile($varName)
	{
		if(file_exists($varName))
			return print('<span style ="color:#007236">Die Datei "'.$varName.'" existiert!</span><br>');
		else
		{
			$file_open = fopen($varName, "w");
			fclose($file_open);
			return print('<span style ="color:#660000">Die Datei "'.$varName.'" wurde erstellt!</span><br>');
		}
