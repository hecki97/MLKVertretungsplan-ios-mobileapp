...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
 <head>
  ...
  <body class="metro">
    <header>
      <nav class="navigation-bar dark fixed-top">
        <nav class="navigation-bar-content">
          ...
          <span class="element-divider place-right"></span>
          <a href="#" class="element place-right no-phone no-tablet"><span class="icon-key"></span> <?=$string['links']['a.menu.login']; ?></a>
          <span class="element-divider place-right"></span>
        </nav>
      </nav>
    </header>
    ...
    <form action="./registration.php" style="display: inline;"><input type="submit" name="register" value="<?=$string['buttons']['b.registration']; ?>"/></form>
 </body>
</html>