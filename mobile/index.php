    ...
    <body class="metro" style="text-align: center;">
          ...
          <nav class="navigation-bar dark fixed-top">
            <nav class="navigation-bar-content" style="text-align: center;">
                <button class="element" onclick="window.location.reload();"><span class="icon-home"></span> MLK-Vertretungsplan<sup><?=$version_sup; ?></sup></button>
            </nav>
          </nav>
        </header>
                ...
                <a href="./mobile_modul.php?do=modul1">
                    <div class="tile double <?=$modul2_bg; ?> box">
                        ...
                        <div class="tile-status">
                            <span class="name" style="text-align: center;"><?=$modul1_tileStatus; ?></span>
                        </div>
                    </div>
                </a>
            </li>
            <li>
                <a href="./mobile_modul.php">
                    <div class="tile double <?=$modul2_bg; ?> box">
                        ...
                        <div class="tile-status">
                            <span class="name" style="text-align: center;"><?=$modul2_tileStatus; ?></span>
                        </div>
                    </div>
                </a>
            </li>
            <li>
                <a href="./mobile_info.php">
                    <div class="tile double bg-gray box">
                        ...
                        <div class="tile-status">
                            <span class="name" style="text-align: center;"><?=$version; ?></span>
                        </div>
                    </div>
                </a>
            </li>
